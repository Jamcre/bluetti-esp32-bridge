...
const char *soft_ap_ssid = "IndoorModuleLab11"; //change according to each module'sIndoorModuleLabXX
//essentially the ESP 32 creates it's own Wifi, this is what shows up as the "hotspot id" 
const char *soft_ap_password = "IndoorModuleLab11";  //and this is the password
