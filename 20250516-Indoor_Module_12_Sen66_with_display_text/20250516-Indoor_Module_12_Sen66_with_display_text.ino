//5_23_25 Libraries downloaded
//lvgl - depends on tft_espi ]
//tft_espi                   ] both are graphics packages


//Ecolibrium Remote Sensor
//Air Quality Monitor

// 5/16 we need to ensure the SSID appears as defined. Maybe we need to format it as "IndoorModuleLabXX". Try with the new circuit (cleaner wiring). Maybe integrate the refactor on Sumit's laptop.

#include <WiFiManager.h> 
#include <WiFi.h>
//#include "ESPAsyncWebServer.h" // this is in quotes bc it's not a library, but a file. (i think)
#include <ESPAsyncWebServer.h>
// https://github.com/me-no-dev/ESPAsyncWebServer/issues/1419 THIS ISSUE IS HERE
// https://github.com/me-no-dev/ESPAsyncWebServer
// We need Asnyc TCP too
#include <AsyncTCP.h>
...
float vocIndex;
float noxIndex;
//uint16_t co2;   //this MAY cause problems
uint16_t co2;
...
/*
MODIFICATIONS:
Modified the Wire.begin() function and added the pin declarations (see above.)
*/
...
//sen5x.setTemperatureOffsetSimple(0.00); //What does this do?
...
void loop(){
  tft.drawString("Pm1p0: " + readPm1p0(), 5, 10, 2);
  tft.drawString("Pm2p5: " + readPm2p5(), 5, 30, 2);
  tft.drawString("Pm4p0: " + readPm4p0(), 5, 50, 2);
  tft.drawString("Pm10p0: " + readPm10p0(), 5, 70, 2);
  tft.drawString("CO2: " + readScdCo2(), 5, 90, 2);
  tft.drawString("Humidity: " + readAmbientHumidity(), 5, 110, 2);
  tft.drawString("Temp: " + readAmbientTemperature(), 5, 130, 2);
  tft.drawString("VocIndex: " + readVocIndex(), 5, 150, 2);
  delay(2000);
}